...
import R3FHeroScene from "./hero/R3FHeroScene";
import HeroLoadingOverlay from "./hero/HeroLoadingOverlay";
  ...
  return (
    <main className="relative">
      <section id="door-hero" className="relative h-screen overflow-hidden">
        ...
        <ArcStroke
          className="pointer-events-none absolute inset-x-0 top-28 z-10 h-full w-full text-white/70"
          dataScrollFade="hero"
        />
