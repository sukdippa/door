...
export default function R3FHeroScene({ modelUrl, triggerId, className = "" }: HeroSceneProps) {
  ...
  // button to print the current values. No HDRI/Environment here — door2.glb
  // ships one (door2-sky.hdr) but it's off for now; lighting is the same
  // sun/ambient/spot rig as the pre-migration door.glb.
