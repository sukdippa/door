...
// door2.glb ships its own equirectangular HDRI sky (unlike the original
// door.glb, which had no environment map — just a flat fog color). Values
// below are a starting point, not yet tuned by eye against the new sky; see
// the "Environment" Leva panel in R3FHeroScene.tsx.
export const DOOR_ENVIRONMENT_MAP_CONFIG = {
  file: "/door2-sky.hdr",
  background: true,
